...
//        _subtotal.value = _subtotal.value?.plus(menuItems[entree]?.price!!)
    }
...
//        _subtotal.value = _subtotal.value?.plus(menuItems[accompaniment]?.price!!)
    ...
    private fun updateSubtotal(itemPrice: Double) {
        if (!_subtotal.value?.equals(null)!!) {

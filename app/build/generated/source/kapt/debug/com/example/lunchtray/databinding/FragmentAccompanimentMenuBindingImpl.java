...
public class FragmentAccompanimentMenuBindingImpl extends FragmentAccompanimentMenuBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        boolean viewModelAccompanimentEqualsJavaLangStringBerries = false;
        boolean viewModelAccompanimentEqualsJavaLangStringBreak = false;
        java.lang.String viewModelMenuItemsBreadDescription = null;
        java.lang.String viewModelMenuItemsBerriesGetFormattedPrice = null;
        boolean viewModelAccompanimentEqualsJavaLangStringPickles = false;
        ...
        if ((dirtyFlags & 0x1bL) != 0) {
            ...
            if ((dirtyFlags & 0x19L) != 0) {
                    ...
                    if (viewModelAccompanimentGetValue != null) {
                        // read viewModel.accompaniment.getValue().equals("berries")
                        viewModelAccompanimentEqualsJavaLangStringBerries = viewModelAccompanimentGetValue.equals("berries");
                        // read viewModel.accompaniment.getValue().equals("break")
                        viewModelAccompanimentEqualsJavaLangStringBreak = viewModelAccompanimentGetValue.equals("break");
                        // read viewModel.accompaniment.getValue().equals("pickles")
                        viewModelAccompanimentEqualsJavaLangStringPickles = viewModelAccompanimentGetValue.equals("pickles");
                    }
            }
        ...
        if ((dirtyFlags & 0x19L) != 0) {
            ...
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.berries, viewModelAccompanimentEqualsJavaLangStringBerries);
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.bread, viewModelAccompanimentEqualsJavaLangStringBreak);
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.pickles, viewModelAccompanimentEqualsJavaLangStringPickles);
        }

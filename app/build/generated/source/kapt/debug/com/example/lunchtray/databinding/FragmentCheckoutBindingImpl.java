...
public class FragmentCheckoutBindingImpl extends FragmentCheckoutBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x181L) != 0) {
            ...
            this.accompanimentPrice.setText(viewModelAccompanimentGetFormattedPrice);
        ...
        if ((dirtyFlags & 0x184L) != 0) {
            ...
            this.entreePrice.setText(viewModelEntreeGetFormattedPrice);
            this.entreeSelection.setText(viewModelEntreeName);
        }
        if ((dirtyFlags & 0x190L) != 0) {
            // api target 1

            this.sidePrice.setText(viewModelSideGetFormattedPrice);
        ...
        if ((dirtyFlags & 0x1a0L) != 0) {
            ...
            this.tax.setText(viewModelTaxGetValue);
        }
        if ((dirtyFlags & 0x188L) != 0) {
            // api target 1

            this.total.setText(viewModelTotalGetValue);
        }
    }

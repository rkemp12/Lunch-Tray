...
public class FragmentSideMenuBindingImpl extends FragmentSideMenuBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        boolean viewModelSideEqualsJavaLangStringSalad = false;
        ...
        boolean viewModelSideEqualsJavaLangStringPotatoes = false;
        ...
        boolean viewModelSideEqualsJavaLangStringRice = false;
        ...
        boolean viewModelSideEqualsJavaLangStringSoup = false;
        ...
        if ((dirtyFlags & 0x1bL) != 0) {
            ...
            if ((dirtyFlags & 0x1aL) != 0) {
                    ...
                    if (viewModelSideGetValue != null) {
                        // read viewModel.side.getValue().equals("salad")
                        viewModelSideEqualsJavaLangStringSalad = viewModelSideGetValue.equals("salad");
                        // read viewModel.side.getValue().equals("potatoes")
                        viewModelSideEqualsJavaLangStringPotatoes = viewModelSideGetValue.equals("potatoes");
                        // read viewModel.side.getValue().equals("rice")
                        viewModelSideEqualsJavaLangStringRice = viewModelSideGetValue.equals("rice");
                        // read viewModel.side.getValue().equals("soup")
                        viewModelSideEqualsJavaLangStringSoup = viewModelSideGetValue.equals("soup");
                    }
            }
        }
        // batch finished
        ...
        if ((dirtyFlags & 0x1aL) != 0) {
            ...
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.potatoes, viewModelSideEqualsJavaLangStringPotatoes);
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.rice, viewModelSideEqualsJavaLangStringRice);
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.salad, viewModelSideEqualsJavaLangStringSalad);
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.soup, viewModelSideEqualsJavaLangStringSoup);
        }
        if ((dirtyFlags & 0x19L) != 0) {
            // api target 1

            this.subtotal.setText(viewModelSubtotalGetValue);
        }
    }
